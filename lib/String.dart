...
final Points_System =
    dashB ? siteConfig['Points_System'] == '1' : f_Points_System;
final bool FriendsFollowers =
    dashB ? siteConfig['Friends_System'] == '1' : f_FriendsFollowers;
final bool InvitationLinks =
    dashB ? siteConfig['InvitationLinks'] == '1' : f_InvitationLinks;
final bool Activate_Audio_Calls =
    dashB ? siteConfig['Activate_Audio_Calls'] == '1' : f_Activate_Audio_Calls;
final bool Activate_Video_Calls =
    dashB ? siteConfig['Activate_Video_Calls'] == '1' : f_Activate_Video_Calls;
...
final bool Active_Admob_Ads =
    dashB ? siteConfig['Active_Admob_Ads'] == '1' : f_Active_Admob_Ads;
final bool Active_AdmobBanner =
    dashB ? siteConfig['Active_AdmobBanner'] == '1' : f_Active_AdmobBanner;
final bool Reels = dashB ? siteConfig['is_Reels'] == '1' : f_Rreels;
final bool Earnings = dashB ? siteConfig['Earnings'] == '1' : f_Earnings;
final bool Social_Links =
    dashB ? siteConfig['app_social_links'] == '1' : f_Social_Links;
final bool Social_Login_Page =
    dashB ? siteConfig['app_social_logins'] == '1' : f_Social_Login_Page;

final String ADMOB_ANDROID_BANNER_ID =
    dashB ? siteConfig['ADMOB_ANDROID_BANNER_ID'] : f_ADMOB_ANDROID_BANNER_ID;
final String ADMOB_IOS_BANNER_ID =
    dashB ? siteConfig['ADMOB_ANDROID_BANNER_ID'] : f_ADMOB_IOS_BANNER_ID;
final String Agora_App_ID = '6a1fcb8a44454844a9b46b271d637e7f';

/// If you want to Add Friend System Then make it true.
final bool Friends_System =
    dashB ? siteConfig['Friends_System'] == '1' : f_Friends_System;
