...
class ChatGPT {
  ...
  static String chatGptToken = OpenAI_CHATGPT_KEY ?? ''; // token
  ...
  static Future<bool> checkRelation(
    ...
    Object content = chatCompletion.choices.first.message.content ?? '';
    bool hasRelation = content.toString().toLowerCase().contains('true');
    debugPrint('---Check the relevance of the problem $hasRelation---');
    return hasRelation;
  }
