                              ...
                              child: Column(
                                children: [
                                              ...
                                              Navigator.of(context)
                                                ...
                                                builder:
                                                    (BuildContext context) =>
                                                        PaypalCheckoutView(
                                                  sandboxMode: false,
                                                  clientId: GetSetList[0]
                                                      ['paypal_id'],
                                                  secretKey: GetSetList[0]
                                                      ['paypal_secret'],
                                                  transactions: [
                                                    {
                                                      "amount": {
                                                      ...
                                                      "description":
                                                          "The payment transaction Top up a balance for a Freeps wallet.",
                                                      // "payment_options": {
                                  ...
                                  if (accounts[0]['sm0'] ==
                                    ...
                                    Column(
                                      children: [
                                        Text('PayPal Test Demo wowondertimelineflutterapp platform'),
                                        GestureDetector(
                                          onLongPress: () {
