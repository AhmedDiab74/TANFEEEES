...
import 'package:wowondertimelineflutterapp/Util/Servers/Api/ApiGoingEvent.dart';
import 'package:wowondertimelineflutterapp/Util/Servers/Api/ApiInvitation.dart';
import 'package:wowondertimelineflutterapp/Util/Servers/Api/ApiInerestEvent.dart';
...
class EventsFetchScreen extends StatefulWidget {
  EventsFetchScreen(
      ...
      required this.idGoingTrueFalse,
      required this.is_going,
      required this.interestedTreuFalse});
  String start_date;
  String end_date;
  String title;
  String imagee;
  ...
  bool is_interested;
  String event_id;
  final idGoingTrueFalse;
  final interestedTreuFalse;
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          InkWell(
                            onTap: () {
                              ApiGoingEvent.folow(widget.event_id);
                              widget.idGoingTrueFalse();
                              setState(() {
                          ...
                          InkWell(
                            onTap: () {
                              setState(() {
                                ApiInerestEvent.events(widget.event_id);
