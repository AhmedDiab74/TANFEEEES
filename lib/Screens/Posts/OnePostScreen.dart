                  ...
                  children: [
                                      ...
                                      InkWell(
                                        onTap: () {
                                          Get.to(EventsFetchScreen(
                                            ...
                                            start_date:
                                                widget.event['start_edit_date'],
                                            title: widget.event['name'],
                                            event_id: widget.event['id'],
                                            idGoingTrueFalse: () {
                                              print(widget.event);
                                              setState(() {
                                                widget.event['is_going'] =
                                                    !widget.event['is_going'];
                                              });
                                            },
                                            interestedTreuFalse: () {
                                              setState(() {
                                                widget.event['is_interested'] =
                                                    !widget
                                                        .event['is_interested'];
                                              });
                                            },
                    ...
                    Container(
                      margin: EdgeInsets.symmetric(
                          horizontal:
                              widget.shared_info.toString().isNotEmpty ? 8 : 0),
                      decoration: BoxDecoration(
                          border: Border.all(
                        width: widget.shared_info.toString().isNotEmpty ? 1 : 0,
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                      onTap: () {
                                        Get.to(ProfileUserScreen(
                                          avat: widget.shared_info['publisher']
                                              ['avatar'],
                                          user_id:
                                              widget.shared_info['publisher']
                                                  ['user_id'],
                                          cover: widget.shared_info['publisher']
                                              ['cover'],
                                          name: widget.shared_info['publisher']
                                              ['name'],
                                        ));
                                      },
                                      child: Row(
                                    ...
                                    Container(
                                      child: widget.shared_info['postText'] ==
                                              null
                                          ? null
                                          : DetectableText(
                                              trimCollapsedText:
                                              ...
                                              trimLines: 4,
                                              text: ReplaceCharacter(widget
                                                  .shared_info['Orginaltext']
                                                  .toString()),
...
////////////////////////////////////////////////////////////////////////////////ColorPost
                                ...
                                ? InkWell(
                                    onTap: () {
                                      Get.to(ImageZoomWidget(
                                        ...
                                        comments: widget.contcoment.toString(),
                              ...
                              InkWell(
                                onTap: () {
                                  Get.to(CommentScreen(
                                    post_id: widget.post_id,
                                    trueflasecommet: widget.trueflasecommet,
        ...
        //                       onTap: () {
        //                         Get.to(CommentScreen(
        //                           post_id: widget.post_id,trueflasecommet: widget.trueflasecommet,
