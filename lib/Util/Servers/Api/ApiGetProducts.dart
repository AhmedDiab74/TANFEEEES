...
class ApiGetProudcts {
  static Future<List<GetProudctsModel>> getprodict(offset, category_id) async {
    ...
    print('prodocutt  ' + accounts[0]['getPro']);
    print('prodocutt  ' + accounts[0]['sm1'] + ' ' + accounts[0]['sm2']);
    print(
      'prodocutt  ' + accounts[0]['li'] + ' 20',
    );
    print(
      'prodocutt  ' + 'offset ' + offset,
    );
    print(
      'prodocutt  ' + accounts[0]['cat'] + ' ' + category_id,
    );
