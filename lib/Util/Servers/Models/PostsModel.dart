...
//   bool is_group_post;
//   String post_share;
//   String postSwowondertimelineflutterapper;
//   final photoMulti2;
//   final shared_info;
//   final photo_album;
//   String urlsss;
...
//     required this.postSwowondertimelineflutterapper,
...
class PostModel {
  ...
  factory PostModel.fromJson(Map<String, dynamic> map) => PostModel(
    blog:map['blog']==null?'':map['blog'],
        ...
        postPrivacy: map['postPrivacy'] == null ? '' : map['postPrivacy'],
        ...
        postType: map['postType'] == null ? '' : map['postType'],
        trueflasecommet:
            map['trueflasecommet'] == null ? '' : map['trueflasecommet'],
        event: map['event'] == null ? '' : map['event'],
        postFileThumb: map['postFileThumb'] == null ? '' : map['postFileThumb'],
        product: map['product'] == null ? '' : map['product'],
        photo_album: map['photo_album'] == null ? '' : map['photo_album'],
        product_id: map['product_id'] == null ? 0 : map['product_id'],
        shared_info: map['shared_info'] == null ? '' : map['shared_info'],
        adminPanel: map['publisher'] == null
            ? ''
            : map['publisher']['admin'] == null
        ...
        post_share: map['post_share'] == null ? '0' : map['post_share'],
        post_comments:
            map['post_comments'] == null ? '0' : map['post_comments'],
        reaction: map['reaction'] == null
            ? 0
            : map['reaction']['count'] == null
                ? '0'
